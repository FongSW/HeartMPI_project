...
from app.utility_function.qualitative.cropped_image.crop_region_vessel_v2 import crop_vessel
...
def prepare_img(hn, file_path):
    ...
    mask_path = [
        f'{cropped_mask_path}/LAD_Mask.jpg',
        f'{cropped_mask_path}/LCX_Mask.jpg',
        f'{cropped_mask_path}/RCA_Mask.jpg'
    ]
    vessel = ['lad', 'lcx', 'rca']
